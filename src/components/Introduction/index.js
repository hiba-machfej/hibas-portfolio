    ...
    <div className="description">
      ...
      <div className="developer">
        ...
        <div className="introduction">
          ...
          <span> "because people who are crazy enough to think that they can change the
          world, are the ones who do." -Steve Jobs</span></p>
          
          <p className="studies">
            I have certificates from <a href="https://www.re-coded.com/">Re:coded</a> and <a href="https://flatironschool.com/">Flatiron</a>, the New York-based
            coding school. I am continuing my Ph.D. in Urban planning. I
            have a master's in Urban Design and a bachelor's degree in
            Architecture.
            <br /> Well, I am always up for a challenge and I love
            learning new things. That's exactly why I chose to learn coding. I
            believe creativity is born from hybrid skills. So, I am quite
            excited to translate my past experiences into digital products.
            aren't you?
          </p>
        </div>
      </div>
